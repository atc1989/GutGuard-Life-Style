...
- [x] **E3-T01** Load the door card from the cookie session (name from Auth metadata / `profiles`). `#task #epic/card`
  - Route: `/card`
...
- [x] **E3-T02** Make the flip target a real button with an accessible name. `#task #epic/card`
  - Route: `/card`
...
- [x] **E3-T03** Show staff QR + monospace card number on the back. `#task #epic/card`
  - Route: `/card`
...
- [x] **E3-T04** Claim the card (`Continue`) and persist claimed state. `#task #epic/card`
...
- [x] **E3-T05** After claim, explain that this is now the Lifestyle Member card. `#task #epic/card`
...
- [x] **E3-T06** Bridge to nearly-free: points are not cash; they only pay for the member’s own first order. `#task #epic/card`
  - Route: `/nearly`
